...
public class ValidateAddressDialog extends Dialog {
    TextView tvConfirm;
    TextView tvCancel;
    TextView tvTitle;
    ...
    public ValidateAddressDialog(Context context, int themeResId) {
        super(context, themeResId);
    }


    public ValidateAddressDialog(Context context) {
        super(context, R.style.ShoppingDeleteDialog);
        this.context = context;
        view = LayoutInflater.from(context).inflate(R.layout.dialog_normals, null);
    }
