package com.ffxz.cosmetics.widget.CustomXrecyclerView;
...
public class SwipeHorXRecyclerView extends RecyclerView {
    ...
    public SwipeHorXRecyclerView(Context context) {
        this(context, null);
    }

    public SwipeHorXRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeHorXRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    /*public void setIndicatorColor(int indicatorColor){
        if (mRefreshHeader != null) {
            mRefreshHeader.setProgressColor(indicatorColor);
        }
    }
    public void setFooterProgressColor(int footerProgressColor){
        if (mFootView instanceof LoadingMoreFooter) {
            ((LoadingMoreFooter) mFootView).setFooterProgressColor(footerProgressColor);
        }
    }*/
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                float dx = mCountX - x;  //dx大于0  说明是往左移动  小于0  说明往右移动
                float dy = mCountY - y;  //dy 大于0  说明是往上移动 小于0  说明是往下移动
        ...
        public void onChanged() {
            ...
            if (mWrapAdapter != null && mEmptyView != null) {
                ...
                if (mWrapAdapter.getItemCount() == emptyCount) {
                    ...
                    SwipeHorXRecyclerView.this.setVisibility(View.GONE);
                } else {

                    mEmptyView.setVisibility(View.GONE);
                    SwipeHorXRecyclerView.this.setVisibility(View.VISIBLE);
                }
            }
        }
    ...
    /*public void setTextColr(int textColor){
        mRefreshHeader.setTextColor(textColor);
    }
    public void setFootColor(int footColor){
        if (mFootView instanceof LoadingMoreFooter) {
            ((LoadingMoreFooter) mFootView).setTextColor(footColor);
        }
    }*/
}