package com.ffxz.cosmetics.widget.Dialog;
...
import com.ffxz.cosmetics.model.SettlementGoodsEntity;
import com.ffxz.cosmetics.ui.adapter.TicketDetailDialogAdapter;
...
public class SettlementGoodsTicketDialog extends Dialog {
	...
	public SettlementGoodsTicketDialog(Activity context) {
		super(context, R.style.Goods_Size_Dialog);
		this.context = context;
	}

	public void setCustomDialog(List<SettlementGoodsEntity.SettlementGoodsData.CouponsBean>  coupons) {
		...
		dialogAdapter = new TicketDetailDialogAdapter(context, coupons);
