 ...
 */
public abstract class CustomLoopPagerAdapter extends PagerAdapter {
    private CustomRollPagerView mViewPager;

    private ArrayList<View> mViewList = new ArrayList<>();

    private class LoopHintViewDelegate implements CustomRollPagerView.HintViewDelegate{
        @Override
    ...
    public CustomLoopPagerAdapter(CustomRollPagerView viewPager){
