...
public class CustomNormalContentDialog extends Dialog {
    TextView tvConfirm;
    TextView tvCancel;
    TextView tvTitle;
    TextView tvContent;
    ...
    public CustomNormalContentDialog(Context context, int themeResId) {
        super(context, themeResId);
    }


    public CustomNormalContentDialog(Context context) {
        super(context, R.style.ShoppingDeleteDialog);
        this.context = context;
        view = LayoutInflater.from(context).inflate(R.layout.dialog_normal_content, null);
    }
