package com.ffxz.cosmetics.ViewHolder;
...
//                    ToastUtils.showToast(MyApplication.getContext(),bean.getTitle() + " is clicked.");
                    break;
                case R.id.tv_sub_1:
//                    ToastUtils.showToast(MyApplication.getContext(),bean.getTitle() + " subItem 1 is clicked.");
                    break;
                case R.id.tv_sub_2:
//                    ToastUtils.showToast(MyApplication.getContext(),bean.getTitle() + " subItem 2 is clicked.");
                    break;
                case R.id.tv_sub_3:
//                    ToastUtils.showToast(MyApplication.getContext(),bean.getTitle() + " subItem 3 is clicked.");
                    break;
            }
        }
    }
