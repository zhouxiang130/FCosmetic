...
//    private List<MineOrderEntity.MineOrderData.MineOrderList> data;
    List<HomeEntity.HomeData.HomeClassify> data;
    /**
     * 页数下标,从0开始(当前是第几页)
     */
    ...
    public HomeGridviewAdapter(Context context, List<HomeEntity.HomeData.HomeClassify> mList, int page, int pageSize) {
