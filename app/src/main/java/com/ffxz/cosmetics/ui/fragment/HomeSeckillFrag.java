...
import com.ffxz.cosmetics.ui.adapter.HomeSeckillActivityAdapter;
...
public class HomeSeckillFrag extends LazyLoadFragment {
	...
	HomeSeckillActivityAdapter mAdapter;
	...
	protected void initView() {
		...
		mAdapter = new HomeSeckillActivityAdapter(getActivity(), mList, flag);
		mRecyclerView.setAdapter(mAdapter);
		if (flag == 1) {
			mAdapter.setOnItemClickListener(new HomeSeckillActivityAdapter.ProfitDetialClickListener() {
				@Override
