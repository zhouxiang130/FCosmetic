...
public class TicketDetailDialogAdapters extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	...
	public TicketDetailDialogAdapters(Context mContext, SettlementsCartEntity.DataBean Coupon) {
		this.mContext = mContext;
		this.Coupon = Coupon.getCoupons();
	...
	public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
		if (holder instanceof ItemViewHolder) {
			((ItemViewHolder) holder).tvDesc.setText(Coupon.get(position).getCouponName());
