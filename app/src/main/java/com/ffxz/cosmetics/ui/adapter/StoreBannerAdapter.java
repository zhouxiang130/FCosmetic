...
import com.ffxz.cosmetics.model.BannerListEntity;
...
public class StoreBannerAdapter extends LoopPagerAdapter {
    ...
    private List<BannerListEntity.DataBean.BannerListBean> mList;
    private Context context;


    public StoreBannerAdapter(RollPagerView viewPager , List<BannerListEntity.DataBean.BannerListBean> mList, Context context){
        super(viewPager);
        this.mList = mList;
    ...
    public View getView(ViewGroup container, final int position) {
        ...
        if(mList == null) {
            ...
            LogUtils.i("我在有banner数据中" +  mList.get(position).getBanner_img());
            view.setScaleType(ImageView.ScaleType.CENTER_CROP);
            view.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
